  ...
  return (
    <div className="h-full min-h-0 overflow-hidden">
      <div className="mx-auto flex h-full max-w-[1800px] flex-col gap-5 overflow-hidden px-4 py-4 md:px-8">
        ...
        {/* ── FILTER BAR ── */}
        <div className="shrink-0 rounded-2xl border border-sky-200 bg-white/90 p-4 shadow-[0_14px_40px_rgba(14,165,233,0.12)] backdrop-blur">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="flex gap-2 flex-wrap sm:flex-nowrap">
              ...
              <select
                ...
                className="min-w-[120px] flex-1 cursor-pointer appearance-none rounded-xl border border-emerald-200 bg-emerald-50/70 px-3 py-3 text-sm font-bold text-slate-700 transition focus:border-emerald-400 focus:bg-white focus:outline-none focus:ring-4 focus:ring-emerald-200/80 sm:flex-none"
              >
                {PRICE_OPTIONS.map((o) => (
              ...
              <select
                ...
                className="min-w-[130px] flex-1 cursor-pointer appearance-none rounded-xl border border-indigo-200 bg-indigo-50/70 px-3 py-3 text-sm font-bold text-slate-700 transition focus:border-indigo-400 focus:bg-white focus:outline-none focus:ring-4 focus:ring-indigo-200/80 sm:flex-none"
              >
                {SORT_OPTIONS.map((o) => (
                  <option key={o.value} value={o.value}>{o.label}</option>
                ))}
