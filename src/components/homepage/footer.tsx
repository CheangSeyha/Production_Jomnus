        ...
        <footer className="w-full bg-slate-50 pt-20 pb-10 border-t border-slate-100 mt-auto">
            <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-5 gap-12">
                ...
                <div className="col-span-2">
                    ...
                    <p className="text-slate-500 text-sm max-w-xs leading-relaxed">
                        The community-powered platform where local experts handle your errands,
                        deliveries, and creative needs with professional care and radical transparency.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul className="text-slate-500 text-sm space-y-2">
                        ...
                        <li className="hover:text-blue-600 cursor-pointer">Become a Performer</li>
            ...
            <div className="max-w-7xl mx-auto px-8 mt-16">
                <div className="bg-white p-6 rounded-2xl border border-slate-200 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div>
                        <h6 className="font-bold text-sm text-slate-900">Join our newsletter</h6>
                        <p className="text-xs text-slate-400">Get the latest updates and community tips delivered to your inbox.</p>
                    </div>
                ...
                <p className="text-center text-slate-400 text-xs mt-12">
                    © {currentYear} TaskExchange Marketplace. All rights reserved. Trusted Curator for Every Task.
                </p>
            </div>
        </footer>
    );
