...
export default function Navbar() {
    ...
    return (
        ...
        {/*  English (US)*/}
        {/*</span>*/}
                <button className="rounded-xl px-4 py-2 text-slate-700 transition hover:bg-slate-100">
                    Log In
                </button>
                <button className="rounded-xl bg-linear-to-r from-blue-600 to-blue-700 px-5 py-2 text-white shadow-[0_8px_20px_rgba(37,99,235,0.35)] transition hover:from-blue-700 hover:to-blue-800">
                    Sign Up
                </button>
                </div>
